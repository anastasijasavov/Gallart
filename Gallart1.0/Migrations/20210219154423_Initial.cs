    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListToPaintings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListToPaintings_Lists_ListId",
                        column: x => x.ListId,
                        principalTable: "Lists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListToPaintings_Paintings_PaintingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListToPaintings_ListId",
                table: "ListToPaintings",
                column: "ListId");

            migrationBuilder.CreateIndex(
                name: "IX_ListToPaintings_PaintingId",
                table: "ListToPaintings",
                column: "PaintingId");
